...
# Make sure State is a factor (categorical)
Group$State <- factor(Group$State, levels = unique(Group$State))

# Scatterplot
ggplot(Group, aes(x = Average.proportion.per.state, y = State)) + 
  geom_point(size = 3, color = "blue") +
  xlab("Average Proportion per State") +
  ylab("State") +
  ggtitle("Average Proportion per State by State")
